...
<%
	...
	System.out.println("update폼에서의 내용>>"+review.getContent().get(0));
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<section class = "container">
		<form name = "boardWrite" action = "./updateReview.do?board_num=<%=request.getParameter("board_num")%>" method = "post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input required type="text" class="form-control" name = "title" id="title" value="<%=review.getTitle().get(0)%>" maxlength="50">
			</div>
			<div class="form-group">
				<label for="content">내용</label>
				<textarea class="form-control" name = "content" id="content" rows="3" style="height:300px;" required><%=review.getContent().get(0) %></textarea>
			</div>
			<div class="form-group">
